...
function initEventLiseners() : void {
    ...
    const switchLabelText = switchLabel?.querySelector("span:last-child") as HTMLElement
...
// export default initEventLiseners()
// (window as any).initEventLiseners = initEventLiseners()

(window as any).addEventListener("DOMContentLoaded", function () { initEventLiseners() })